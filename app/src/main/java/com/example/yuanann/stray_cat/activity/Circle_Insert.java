...
public class Circle_Insert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circle_insert);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(Circle_Insert.this, MainActivity.class);
                startActivity(intent);
            }
        });
        Spinner spinner =findViewById(R.id.ed1);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                Toast.makeText(Circle_Insert.this, "你点击的是:"+type[pos], Toast.LENGTH_SHORT).show();
                e1=type[pos];
            }
            @Override
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences sp = Circle_Insert.this.getSharedPreferences("User", MODE_PRIVATE);
                final String name =sp.getString("name", null);
                if (TextUtils.isEmpty(e2)) {
                    Toast.makeText(Circle_Insert.this, "请输入找到/遗失猫地点", Toast.LENGTH_SHORT).show();
                }else  if (TextUtils.isEmpty(e3)) {
                    Toast.makeText(Circle_Insert.this, "请输入猫咪品种", Toast.LENGTH_SHORT).show();
                }else  if (TextUtils.isEmpty(e4)) {
                    Toast.makeText(Circle_Insert.this, "请输入猫咪简介", Toast.LENGTH_SHORT).show();
                }else if(fileName==null){
                    Toast.makeText(Circle_Insert.this, "发布一张图片吧...", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(Circle_Insert.this, "发布成功", Toast.LENGTH_SHORT).show();
                    DatabaseHelper dbHelper = new DatabaseHelper(Circle_Insert.this);
                    ContentValues values = new ContentValues();

                    SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                    Date curDate = new Date(System.currentTimeMillis());//获取当前时间
                    String str = formatter.format(curDate);
                    values.put("o_demand", e1);
                    values.put("o_place", e2);
                    values.put("o_type", e3);
                    values.put("o_content",e4);
                    values.put("o_sendname",name);
                    values.put("o_pic",fileName);
                    values.put("o_time", str);
                    dbHelper.insertCircle(values);
