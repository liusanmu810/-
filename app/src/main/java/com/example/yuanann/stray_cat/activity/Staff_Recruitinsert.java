...
public class Staff_Recruitinsert extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staff__recruitinsert);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish();
                intent.setClass(Staff_Recruitinsert.this,Recruit.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Staff_Recruitinsert.this.finish();
                String t = ed1.getText().toString();
                String c = ed2.getText().toString();
                finish();
                Intent intent = new Intent();
                intent.setClass(Staff_Recruitinsert.this, Fm.class);
                intent.putExtra("t",t);
                intent.putExtra("c",c);
                intent.putExtra("trans","志愿者添加");
                startActivity(intent);
            }
        });
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String c2=ed1.getText().toString().trim();
                int img=head;
                SharedPreferences sp = Staff_Recruitinsert.this.getSharedPreferences("User", MODE_PRIVATE);
                final String name =sp.getString("name", null);
                if (TextUtils.isEmpty(c1)) {
                    Toast.makeText(Staff_Recruitinsert.this, "请输入活动标题", Toast.LENGTH_SHORT).show();
                }else if (TextUtils.isEmpty(c2)) {
                    Toast.makeText(Staff_Recruitinsert.this, "请输入活动内容", Toast.LENGTH_SHORT).show();
                }else if(img==0){
                    Toast.makeText(Staff_Recruitinsert.this, "请选择一张活动封面", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(Staff_Recruitinsert.this, "志愿者活动发布成功", Toast.LENGTH_SHORT).show();
                    DatabaseHelper dbHelper = new DatabaseHelper(Staff_Recruitinsert.this);
                    ...
                    values.put("c_man", number);
                    values.put("c_content",c2);
                    values.put("c_time", str);
                    dbHelper.insertRe(values);
